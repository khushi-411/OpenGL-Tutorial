...
def main(_output_size, _num_epochs, _batch_size, _learning_rate, _device):
    ...
    try:
        ...
        # model instance
        _model = LeNet5(_output_size).to(_device)
        print(_model)
...
if __name__ == "__main__":
    ...
    main(_output_size, _num_epochs, _batch_size, _learning_rate, _device)
