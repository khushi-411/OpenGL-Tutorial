...
#
# Lab Program 5
# Contents: Detect corners in an image using Harris corner detection, Shi-Tomasi Corner Detector and FAST algorithm.
#
##################################################################
...
def harris(img):
    ...
    # to save the image
    cv2.imwrite('images/outputs/ques1_harris_3.png', _img)
...
def shi_tomasi(img):
    ...
    cv2.imwrite('images/outputs/ques1_shi_tomasi_3.png', __img)
...
def fast_algo(img):
    ...
    cv2.imwrite('images/outputs/ques1_fast_3_with.png', img1)
    cv2.imwrite('images/outputs/ques1_fast_3_without.png', img2)
